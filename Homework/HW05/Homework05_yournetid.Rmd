...
date: "Due on Canvas by 11:59pm on Wednesday November 1"
output:
  html_document:
    toc: yes
---
...
In a past iteration of PSTAT 10, the student demographics of the class (specifically which major/s students were enrolled in) was recorded. The data has been stored in the file `roster.csv` in the `data` folder. The dataset contains three columns:
